...
public class UserDataDAO {
    ...
    public boolean registerUser(UserDataDTO userDTO) throws SQLException {
    ...
    public List<UserAccountDTO> getAccountDetails(int userId) throws SQLException {
        List<UserAccountDTO> accountList = new ArrayList<>();
    ...
    public UserDataDTO getUserDetails(String name, String pass) throws SQLException {
